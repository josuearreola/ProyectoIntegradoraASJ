...
<body>
    ...
    <section id="container">
        <?php
        $busqueda = strtolower($_REQUEST['buscarProd']);
        if (empty($busqueda)) {
        ...
        <div class="container">
            <div class="table-responsive">
                <table class="table table-sm table-dark table-hover table-striped">
                    ...
                    <?php
                    //paginador//
                    $sql_register = mysqli_query($conexion, "SELECT count(*) as total_registro 
                                                            from marca 
                                                            inner join modelo on marca.id_marca = modelo.id_marca 
                                                            inner join telefono on modelo.id_mod=telefono.id_mod
                                                            where (marca.nom_marc LIKE '%$busqueda%' OR  
                                                                    modelo.nom_mod LIKE '%$busqueda%' OR 
                                                                    telefono.id_tel LIKE '%$busqueda%' OR 
                                                                    telefono.col_tel LIKE '%$busqueda%' OR 
                                                                    telefono.cam_tel LIKE '%$busqueda%' OR
                                                                    telefono.alm_tel LIKE '%$busqueda%' OR
                                                                    telefono.ram_tel LIKE '%$busqueda%' OR
                                                                    telefono.pan_tel LIKE '%$busqueda%' OR
                                                                    telefono.bat_tel LIKE '%$busqueda%' OR
