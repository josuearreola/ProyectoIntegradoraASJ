...
$pdf->Cell(275,10,'REPORTE DE PRODUCTOS x COSTO',0,0,'C');
...
$sql="SELECT nom_marc,nom_mod,col_tel,cam_tel,alm_tel,ram_tel,pan_tel,bat_tel,proc_tel,prec_tel,costo_tel,img_tel from marca inner join modelo on marca.id_marca=modelo.id_marca inner join telefono on modelo.id_mod=telefono.id_mod where costo_tel between $costoMin and $costoMax order by costo_tel asc";
