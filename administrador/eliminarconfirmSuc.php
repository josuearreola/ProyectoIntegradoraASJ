...
if (!empty($_POST)) {
    ...
    $query_delete1 = mysqli_query($conexion, "UPDATE sucursal SET estatus = 0 where id_suc=$idSucursal ");
    if ($query_delete1) {
...
if (empty($_REQUEST['id'])) {
    ...
    $idSuc = $_REQUEST['id'];
    $query = mysqli_query($conexion, "select nom_suc,col_suc,cp_suc,ni_suc,ne_suc,call_suc from sucursal where sucursal.id_suc='$idSuc'");
...
<body>
    ...
    <section id="container">
        ...
        <div class="data_delete">
            <h2 class="h2preg">¿Esta seguro de eliminar la siguiente sucursal?</h2>
            <p class="p-text">Nombre de la sucursal : <span><?php echo $nombre ?></span></p>
            <p class="p-text">Colonia : <span><?php echo $colonia ?></span></p>
            <p class="p-text">CP : <span><?php echo $cp ?></span></p>
            <p class="p-text"># Interior : <span><?php echo $ni ?></span></p>
            <p class="p-text"># Exterior : <span><?php echo $ne ?></span></p>
